...
setup(
    name='topology_lib_ansible',
    version=find_version('lib/topology_lib_ansible/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_ansible/tree/master/doc',
    keywords='topology_lib_ansible',
    ...
    entry_points={
        'topology_library_10': [
            'ansible = topology_lib_ansible.library'
        ]
    }
)
